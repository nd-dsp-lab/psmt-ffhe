...
echo "Max Items Per Bin: $MAX_ITEMS_PER_BIN" > params_info.txt
echo "PS Low Degree: $PS_LOW_DEGREE" >> params_info.txt
echo "Query Powers: $QUERY_POWERS" >> params_info.txt
